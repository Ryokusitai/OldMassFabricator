...
public class GuiOldMassFabricator extends GuiContainer
{
	...
	OldMassFabricatorTile containerTile;
	...
	protected void drawGuiContainerForegroundLayer(int var1, int var2) {
		...
		this.fontRendererObj.drawString(Integer.toString(containerTile.getProgress())+"%", 14, 20+10, 4210752);

		if (containerTile.getScrap() != 0) {
			this.fontRendererObj.drawString("Amplifier:", 14, 20+10+17, 4210752);
			this.fontRendererObj.drawString(Integer.toString(containerTile.getScrap()), 14, 20+10+17+13, 4210752);
		}
